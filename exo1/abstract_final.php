...
abstract class playeranonyme
{
  public function __construct(protected string $name = 'anonyme', protected float $ratio = 400.0)
  {
  }
...
class Player extends  playeranonyme
{
  ...
  protected function probabilityAgainst(playeranonyme $player): float
  {
    return 1 / (1 + (10 ** (($player->getRatio() - $this->getRatio()) / 400)));
  }

  public function updateRatioAgainst(playeranonyme $player, int $result): void
  {
